...
export const metadata: Metadata = {
  ...
  description: "Licensed since 2013, ranked in the top 1% of agents statewide, Amy Casanova has closed over 650 transactions across Western Arizona.",
};
